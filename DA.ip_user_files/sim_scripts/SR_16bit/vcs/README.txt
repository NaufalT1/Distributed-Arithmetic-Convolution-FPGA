...
#
# Generated by export_simulation on Wed Mar 18 12:03:46 +0700 2020
#
################################################################################
...
'-reset_run' switch to the './SR_16bit.sh' script.

./SR_16bit.sh -reset_run
...
./SR_16bit.sh -noclean_files

For more information on the script, please type './SR_16bit.sh -help'.
