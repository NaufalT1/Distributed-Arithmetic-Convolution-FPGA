...
#
# Generated by export_simulation on Wed Oct 07 14:42:48 +0700 2020
#
################################################################################
...
'-reset_run' switch to the './SR_1bit.sh' script.

./SR_1bit.sh -reset_run
...
./SR_1bit.sh -noclean_files

For more information on the script, please type './SR_1bit.sh -help'.
