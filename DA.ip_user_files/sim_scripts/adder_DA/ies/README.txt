...
#
# Generated by export_simulation on Thu Oct 22 11:51:46 +0700 2020
#
################################################################################
...
'-reset_run' switch to the './adder_DA.sh' script.

./adder_DA.sh -reset_run
...
./adder_DA.sh -noclean_files

For more information on the script, please type './adder_DA.sh -help'.
