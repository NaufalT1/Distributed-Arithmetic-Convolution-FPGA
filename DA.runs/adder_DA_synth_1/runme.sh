...
HD_PWD='E:/OneDrive/Documents/Vivado/SIGNED/DA/DA.runs/adder_DA_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_DA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_DA.tcl
