...
HD_PWD='E:/OneDrive/Documents/Vivado/SIGNED/DA/DA.runs/HAdder_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HAdder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HAdder.tcl
