...
HD_PWD='E:/OneDrive/Documents/Vivado/SIGNED/DA/DA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_LVL_CUST.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_LVL_CUST.tcl -notrace
