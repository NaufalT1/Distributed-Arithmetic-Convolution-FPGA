...
HD_PWD='C:/Users/naufa/OneDrive/Documents/Vivado/SIGNED/DA/DA.runs/SR_1bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SR_1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SR_1bit.tcl
