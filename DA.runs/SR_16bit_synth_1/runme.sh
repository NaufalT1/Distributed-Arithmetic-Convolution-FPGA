...
HD_PWD='F:/OneDrive/Documents/Vivado/DA/DA.runs/SR_16bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SR_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SR_16bit.tcl
