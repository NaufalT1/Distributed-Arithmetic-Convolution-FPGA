...
HD_PWD='E:/OneDrive/Documents/Vivado/SIGNED/DA/DA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_LVL_CUST.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_LVL_CUST.tcl
