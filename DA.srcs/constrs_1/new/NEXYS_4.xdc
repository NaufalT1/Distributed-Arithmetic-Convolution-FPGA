...
## Clock signal
##Bank = 35, Pin name = IO_L12P_T1_MRCC_35,					Sch name = CLK70,92MHZ
set_property PACKAGE_PIN E3 [get_ports Clk]
set_property IOSTANDARD LVCMOS33 [get_ports Clk]
create_clock -period 14.500 -name sys_clk_pin -waveform {0.000 7.250} -add [get_ports Clk]
...
set_property IOSTANDARD LVCMOS33 [get_ports LED_bobot_cmplt]
##Bank = 34, Pin name = IO_L21N_T3_DQS_34,					Sch name = LED1
set_property PACKAGE_PIN V9 [get_ports LED_masukan_cmplt]
set_property IOSTANDARD LVCMOS33 [get_ports LED_masukan_cmplt]
##Bank = 34, Pin name = IO_L24P_T3_34,						Sch name = LED2
set_property PACKAGE_PIN R8 [get_ports LED_conv_cmplt]
set_property IOSTANDARD LVCMOS33 [get_ports LED_conv_cmplt]
